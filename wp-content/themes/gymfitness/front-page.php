...
<main class="contenedor seccion">
    ...
    <?php gymfitness_lista_clases(2); ?>

    <div class="contenedor-boton">
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('Nuestras clases'))); ?>" class="boton boton-primario">
...
<section class="contenedor seccion">
    ...
    <p class="text-center">Instructores profesionales que te ayudan a lograr tus objetivos</p>

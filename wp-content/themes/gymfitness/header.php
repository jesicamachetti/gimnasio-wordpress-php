...
<head>
    ...
    <?php wp_head(); ?><!--trabaja en conjunto con la funcion que se creo en functions y en la hoja de estilo le agregamos los estilos-->
</head>
<!--un tema se usa para el diseno y un plugin para la funcionalidad-->

<body <?php body_class(); ?>>
    <header class="header">
        <div class="contenedor barra-navegacion">
            <div class="logo">
                <!--site url te lleva a la pagina de inicio--->

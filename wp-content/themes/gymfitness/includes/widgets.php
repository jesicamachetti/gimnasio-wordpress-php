...
<!--widefat para que el imput se coloque en la parte inferior-->
<input  
...
/>
	...
	public function update( $new_instance, $old_instance ) {
        $instance = array();
        $instance['cantidad'] = (!empty($new_instance['cantidad'])) ? sanitize_text_field($new_instance['cantidad']) : ''; /**si la nueva instancia cantidad no esta vacia vamos a utilizar la funcion de sanitizar datos  */

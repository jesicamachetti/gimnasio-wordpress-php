...
// Registrar Custom Post Type- este codigo registra una nueva seccion llamada clases
function gymfitness_clases_post_type() {
	...
	$args = array(
		...
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ),//custom-fields es para habilitar campos personalizados
